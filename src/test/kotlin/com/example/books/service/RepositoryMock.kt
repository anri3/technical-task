...
class AuthorsRepository {
    fun insert(bookId: Int, name: String, birthday: LocalDate): Int { throw UnsupportedOperationException("Not implemented for mock") }
    fun updateById(request: AuthorRequest) { throw UnsupportedOperationException("Not implemented for mock") }
...
class BooksRepository {
    fun selectCountForExists(request: BookRequest): Int { throw UnsupportedOperationException("Not implemented for mock") }
    fun insert(request: BookRequest): Int { throw UnsupportedOperationException("Not implemented for mock") }
    fun selectCountById(bookId: Int): Int { throw UnsupportedOperationException("Not implemented for mock") }
    fun updateById(bookId: Int, request: BookRequest) { throw UnsupportedOperationException("Not implemented for mock") }
